...
-- Stores the durable metadata produced while processing a dataset session.
--
-- The cleaned/prepared CSV files are transient processing artifacts and are
-- deliberately not written to app/storage/sessions.  The original upload is
-- kept in the configured Supabase Storage bucket, while the reports and
-- prepared-dataset profile needed to audit or display a session live here.
-- =========================================================
