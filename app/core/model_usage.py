...
def multi_dashboard_model_usage(
    ...
    Preparation, synthesis, and dashboard generation are always part of the
    workflow. Specialist models are included only when the orchestrator has
    selected the corresponding specialist.
    """
    selected = set(selected_agents)
    configured_agents = ["data_preparation"]
